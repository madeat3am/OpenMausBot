...
import { actionsFromMcpPayload, AutonomyAuthority, parseAutonomyPolicy } from "./autonomy-policy.ts";
...
describe("autonomy policy", () => {
  ...
  it("enforces routine, originating-thread, recipient, and argument constraints", () => {
    ...
    const action = {
      ...
      arguments: { thread_id: "thread-1", recipient_alias: "trey", mode: "reply" },
    };
